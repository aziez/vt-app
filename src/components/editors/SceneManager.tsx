...
import { Upload, Edit, Trash2, Play, X, Menu } from "lucide-react";
...
const SceneManager: React.FC<SceneManagerProps> = ({ isOpen, onToggle }) => {
  const {
    tour,
    addScene,
    removeScene,
  ...
  return (
    ...
    >
      <Card className="bg-white shadow-md h-full rounded-none">
